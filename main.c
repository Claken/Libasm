...
void	test_ft_strcmp()
{
	...
	printf("		\x1b[33m<string.h>\x1b[0m  %d\n", strcmp("qwertyuiop", "qwertyuioptest"));
	printf("		\x1b[33mft_ libasm\x1b[0m  %d\n", ft_strcmp("qwertyuiop", "qwertyuioptest"));
	printf("	\x1b[34m[6]\x1b[0m \x1b[36m'bbbonjour' 'bbonjour'\x1b[0m\n");
	printf("		\x1b[33m<string.h>\x1b[0m %d\n", strcmp("bbonjour", "bbbonjour"));
	printf("		\x1b[33mft_ libasm\x1b[0m %d\n", ft_strcmp("bbonjour", "bbbonjour"));
...
void	test_ft_strlen()
{
	...
	printf("	\x1b[34m[4]\x1b[0m \x1b[36m'NULL'\x1b[0m\n");
	printf("		\x1b[33m<string.h>\x1b[0m  %s\n", "SEGMENTATION FAULT");
	//printf("		\x1b[33m<string.h>\x1b[0m  %ld\n", strlen(NULL));
	printf("		\x1b[33mft_ libasm\x1b[0m  %s\n", "SEGMENTATION FAULT");
	//printf("		\x1b[33mft_ libasm\x1b[0m  %d\n", ft_strlen(NULL));
}
